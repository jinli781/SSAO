Shader "Hidden/SSAO"
{
    SubShader
    {
        CGINCLUDE
            ...
            float _SampleCount, _Radius, _AOInt;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float3x3 wTBN = float3x3(wTan, wBin, wNor);
                ...
                for (int j = 0; j < sampleCount; j++) {
                    ...
                    float rangeCheck = smoothstep(0, 1.0, _Radius / abs(sampleZ - sampleDepth) * 0.1);
                    fixed selfCheck = (sampleDepth + 0.08 < eyeDepth) ? 1 : 0;
        ...
        Pass
        {
            ...
            fixed4 frag_final(v2f i) : SV_Target
            {
             ...
             float4 finalCol = lerp(_AOCol * scrTex, scrTex, aoTex.x);
             return finalCol;
            }
            ENDCG
        }
